    ...
    public class ConversationService : IConversationService
    {
        ...
        public ConversationViewModel CreateConversationViewModel(string conversationId)
        {
            ...
            var viewModel = new ConversationViewModel
            {
                ...
                StartDateTime = DateTime.Now,
                EndDateTime = DateTime.Now,
                TopGlobalMistakesForLanguage = this.mistakeRepository.GetTopRemarksForLanguage(conversation.LanguageId, false),
                LatestSessionMistakes = this.mistakeRepository.GetLatestSessionRemarks(conversation.Id, false),
                MostCommonSessionMistakes = this.mistakeRepository.GetTopRemarksForSession(conversation.Id, false),
                MostCommonMistakesForStudent = this.mistakeRepository.GetTopRemarksForStudent(student.Id, false),
                Language = language,
        ...
        public ConversationViewModel RecreateConversationViewModel(Guid conversationId, string spokenValue, string correctValue)
        {
            ...
            var viewModel = new ConversationViewModel
            {
                ...
                Student = student,
                TopGlobalMistakesForLanguage = this.mistakeRepository.GetTopRemarksForLanguage(savedConversation.LanguageId, false),
                LatestSessionMistakes = this.mistakeRepository.GetLatestSessionRemarks(conversationId, false),
                MostCommonSessionMistakes = this.mistakeRepository.GetTopRemarksForSession(conversationId, false),
                MostCommonMistakesForStudent = this.mistakeRepository.GetTopRemarksForStudent(student.Id, false),
